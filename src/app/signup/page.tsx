...
import { Sparkles, Mail, Lock, Eye, EyeOff, ArrowRight, User, Building2 } from "lucide-react";
        ...
        <main className="min-h-screen bg-background text-foreground flex">
                ...
                <div className="w-full max-w-md animate-fade-in-up">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground font-medium">
                            アカウントを作成して、AIによる広告制作を体験しましょう
                        </p>
                    </div>

                    {/* Social Signup */}
                    <div className="space-y-3 mb-8">
                        <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 transition-all font-bold">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="8文字以上"
                                    className="w-full pl-12 pr-12 py-3 rounded-xl bg-white border border-gray-200 focus:border-primary/50 focus:outline-none transition-colors font-medium"
                                />
                                <button
                                    type="button"
                        ...
                        <Button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-gradient-to-r from-primary to-accent hover:opacity-90 text-white font-black text-lg py-6 shadow-xl hover:scale-105 transition-all group"
                        >
                            {isLoading ? (
            ...
            <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 via-accent/10 to-background items-center justify-center p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center max-w-lg animate-scale-in">
                    <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto mb-8 shadow-2xl">
                        <Sparkles className="w-12 h-12 text-white" />
                    </div>
                    <h2 className="text-3xl font-black mb-4 font-heading">
                        14日間無料トライアル
                    </h2>
                    ...
                    <ul className="text-left space-y-3">
                        <li className="flex items-center gap-3">
                            ...
                            <span className="font-medium">無制限の広告生成</span>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center">
                                <svg className="w-3 h-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span className="font-medium">すべてのテンプレート利用可能</span>
                        </li>
                        <li className="flex items-center gap-3">
                            <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center">
                                <svg className="w-3 h-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
